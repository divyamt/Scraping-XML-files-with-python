...
for item in tree:
  print("Name:",item.find('COMMON').text)
  print("Botanical name:",item.find('BOTANICAL').text)
  print("Zone:",item.find('ZONE').text)
  print("Light:",item.find('LIGHT').text)
  print("Price:",item.find('PRICE').text)
  print("Availability:",item.find('AVAILABILITY').text)
  print("\n")
